...
export default function LaunchForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!allocationValidation.isValid) {
            alert("Please fix allocation errors before launching");
            return;
        }
        launch(formData);
    };
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button type="submit" disabled={isLoading || !allocationValidation.isValid} className="w-full bg-blue-600 text-white py-3 rounded-lg font-semibold hover:bg-blue-700 disabled:opacity-50">
